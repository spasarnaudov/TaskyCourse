...
class EventViewModel @Inject constructor(
    ...
    var state = MutableStateFlow(EventViewModelState())
        private set
    ...
    fun onEvent(event: EventEvent) {
        when (event) {
            ...
            is EventEvent.SelectCalendarDateAction -> {
                state.update {
                    it.copy(
            ...
            is EventEvent.SelectDateAction -> {
                state.update {
                    it.copy(
                        selectedDate = event.date,
                    )
            ...
            is EventEvent.SelectAgendaItemMenu -> {

            }
            is EventEvent.SelectAgendaDone -> {
